      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview sub-documents">
          ...
          <ul class="treeview-menu">
            ...
            <li class="treeview-menu-documents" id="sub-create-document"><a href="{{Route('create_document')}}"><i class="fa fa-circle-o"></i> Documents </a></li>
            ...
            <li class="treeview-menu-documents" id="sub-document-tracking"><a href="{{Route('document/tracking')}}"><i class="fa fa-circle-o"></i> Document Tracking </a></li>
