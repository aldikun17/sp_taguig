@include('receiver.includes.header.header')
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview sub-documents">
          ...
          <ul class="treeview-menu">
            ...
            <li class="treeview-menu-documents" id="sub-create-document"><a href="{{Route('receiver/documents')}}"><i class="fa fa-circle-o"></i> Documents </a></li>
...
@include('receiver.includes.footer.footer')